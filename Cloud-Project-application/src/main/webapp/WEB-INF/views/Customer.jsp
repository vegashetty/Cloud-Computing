    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <ul class="nav navbar-nav" >
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="Transfer.htm">At Marvel Bank</a></li>
...
<form class="form-1">
 ...
 <label for='Persnal Accounts' id= 'Persnal Accounts' ><font color="#ffffff">Personal account</font></label><br>
 <a href="BalanceDetails.htm"><font color="#ffffff">Marvel Core <c:out value="${accounttype}"></c:out> - $s<c:out value="${balance}"></c:out>
  </font></a><br>
   <a href="#"><font color="#ffffff" size="2px">Quick View</font></a>
  </div>
</div>
</form>
