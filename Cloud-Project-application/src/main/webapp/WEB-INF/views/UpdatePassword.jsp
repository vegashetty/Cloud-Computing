...
function updatePassword(){
	...
	var query = "oldPassword=" + oldPassword+ "&newPassword=" + newPassword+ "&securityAns=" + securityAns;
	...
	xmlHttp.open("POST", "UpdatePassword.htm", true);
			...
			<div class='col-lg-4' align="center">
               ...
               <input type="password" class="form-control" id='securityAns' placeholder="Answer" required><br>
					...
					<div class='col-lg-5' align='left'>
						<label for='oldPassword'><font color="#ffffff">Old Password:</font></label>

					</div>
					<div class='col-lg-6' style='padding-right: 10px'>
						
               <input type="password" class="form-control" id='oldPassword' placeholder="Old Password" required><br>
   </div>
