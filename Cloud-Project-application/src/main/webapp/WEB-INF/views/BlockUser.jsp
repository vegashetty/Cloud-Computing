...
function blockUser(){
	...
	xmlHttp.onreadystatechange = function stateChanged(){
		if( xmlHttp.readyState == 4 ){
			...
			document.getElementById("result").innerHTML = json.blockmessage;
    ...
    <div class="row">
        <div class="col-sm-3">
            ...
            <ul class="nav nav-pills nav-stacked">
                ...
                <li><a href="#"><i class="glyphicon glyphicon-remove-sign"></i> Block users</a></li>
        ...
        <div class="col-sm-9">
            ...
            <div class="row">
              ...
              <input type='text' class='form-control' id='userID' required='true'>
