    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <ul class="nav navbar-nav" >
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="Customer.htm">At Marvel Bank</a></li>
           </ul>
...
<div class='row-lg-6' align="center">
 ...
 <form action="MakeTransfer.htm" method="post">
  ...
  <div class='col-lg-6' align='left'>
						<label for='from'><font color="#ffffff">From Account  :</font></label>

					</div>
					<div class='col-lg-6' style='padding-right: 10px'>
					
      <select class="form-control" id="fromAc" name="fromAC">
      <c:forEach var="addBeni" items="${requestScope.benficaList}">
        <option value="${addBeni.fromAccountNo}"><c:out value="${addBeni.fromAccountNo}"></c:out></option>
       
        </c:forEach>
      </select>
   </div>
 <div class='col-lg-6' align='left'>
						<label for='addPayee'><font color="#ffffff">Add Payee:</font></label>

					</div>
					<div class='col-lg-6' style='padding-right: 10px'>
					
    <br>  <select class="form-control" id="addPayee" name="toAC">
        <c:forEach var="addBeni" items="${requestScope.benficaList}">
        <option value="${addBeni.toAccountNo}"><c:out value="${addBeni.toAccountNo}"></c:out></option>
        </c:forEach>
      </select>
   </div>
           <br> <div class='col-lg-6' align='left'>
						<br><label for='amount'><font color="#ffffff">Amount:</font></label>

					</div>
					<div class='col-lg-6' style='padding-right: 10px'>
						
              <br> <input type="text" class="form-control" id='amount' name="amount" placeholder="Amount" required><br>
               </div>
                <div class='col-lg-6' align='left'>
						<label for='description'><font color="#ffffff">Description:</font></label>
               ...
               <div class='col'>
						...
						<br> <input type='submit' class='btn btn-info' value='Transfer'>
					</div>
   </form>
  </div>
</div>
