...
function addAccount(){
	...
	var addAccount = document.getElementById("addAccount").value;
	
	var query = "addAccount=" + addAccount;
	xmlHttp.onreadystatechange = function stateChanged(){
		if( xmlHttp.readyState == 4 ){
			var json = JSON.parse(xmlHttp.responseText);
			document.getElementById("result").innerHTML = json.accountAdded;
			document.getElementById("myForm").reset();
			
		}
	};
	xmlHttp.open("POST", "AddPayee.htm", true);
...
<div class='row-lg-6' align="center">
 ...
 <span id="result" ></span>
 <form action="AddPayee.htm" method ="post" id='myForm'>
 <div class='col-lg-6' align='left'>
						<br><label for='addPayee'><font color="#ffffff">Add Payee:</font></label>

					</div>
					<div class='col-lg-6' style='padding-right: 10px'>
						
               <input type="text" class="form-control" id='addAccount' placeholder="Account No" name="addAccount" required><br>
   </div>
