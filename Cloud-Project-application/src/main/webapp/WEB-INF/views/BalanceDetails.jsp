...
table#AcDetails tr:nth-child(even) {
    background-color: #eee;
}
table#AcDetails tr:nth-child(odd) {
...
<br><br><table id="AcDetails" border=1>
  <tr>
    <th>Date</th>
    <th>Discription</th>    
    <th>Amount Deducted/Added</th>
    <th>Amount Available</th>
  
  
  <c:forEach var="bd" items="${requestScope.ac}">
  <tr>
    <td>${bd.orderDate}</td>
    <td>${bd.description}</td>    
    <td>${bd.amountDeducted}</td>
    <td>${bd.availableBalance}</td>
    </tr>
    </c:forEach>
  </tr>
